...
#define TAP_CODE_DELAY 10 // ミリ秒 
#define TAPPING_TERM 300 // ミリ秒
...
#define AUTO_MOUSE_TIME 1000d // マウスが止まってから元のレイヤーに戻るまでの時間(ms)
#define AUTO_MOUSE_THRESHOLD 40 // どの程度動かしたらマウスレイヤーに切り替えるかの閾値